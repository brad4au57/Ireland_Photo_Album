...
function Thumbnail() {
  return (
    <section id="thumbnails">
      <article>
        <a className="thumbnail" href=" " data-position="left center">
          <img
            src="https://study-eu.s3.amazonaws.com/uploads/image/path/118/wide_fullhd_ireland-cliffs-of-moher.jpg"
            alt=""
          />
        </a>
      ...
      <article>
        ...
        <p>
          Etiam ultricies, lorem quis efficitur porttitor, facilisis ante orci
          urna.
        </p>
      </article>
      <article>
      ...
      <article>
        ...
        <p>
          In quis vulputate dui. Maecenas metus elit, dictum praesent lacinia
          lacus.
        </p>
      </article>
      <article>
      ...
      <article>
        ...
        <p>
          Feugiat auctor leo massa, nec vestibulum nisl erat faucibus, rutrum
          nulla.
        </p>
      </article>
    </section>
